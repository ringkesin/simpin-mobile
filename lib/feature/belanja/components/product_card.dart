        ...
        children: [
                ...
                children: [
                  Positioned.fill(
                    child: Container(
                      ...
                      child: const Center(child: Icon(LucideIcons.image, color: Color(0xFF9CA3AF))),
                    ),
                  ),
                  if (hasDiscount)
                    Positioned(
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(formatRp(product.price), style: GoogleFonts.lexendDeca(fontSize: 14.5, fontWeight: FontWeight.w700, color: AppColors.primaryTextLight)),
                if (hasDiscount)
                  Padding(
